...
var RequestNetprotocol=Java.type('cj.studio.nettest.be.args.RequestNetprotocol');
...
exports.flow = function(f,c,ctx) {
	...
	var netprocol=ptStub.getMyRequestNetprotocol(mid,creator);
	c.content().writeBytes(new Gson().toJson(netprocol).getBytes());
}
